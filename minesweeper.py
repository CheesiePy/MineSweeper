...
class GamePlay:
    """the GamePlay class manege the input of the player with the board"""
...
class Board:
    """ the Board class sets up the terms of the game"""
    ...
    def _create_board(self):
        """ this func create a board map matrix in order nxn"""
...
def main():
    ...
    while not game_key:
        ...
        if game.win:
            print("you won! nicly done {0}".format(player_name))
        continue_game = "?"
        ...
        if continue_game == "Y":
            ...
            game_key = True
    print("Thanks for playing minesweep by May Lindenberg")
